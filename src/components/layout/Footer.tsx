      ...
      <div className="page-container py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div className="md:col-span-1">
            ...
            <p className="text-muted-foreground mt-4 text-sm">
              AI-powered recruitment platform that transforms hiring with intelligent 
              resume analysis, automated interviews, and job matching.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li><Link to="/upload" className="text-sm text-muted-foreground hover:text-primary transition-colors">Resume Upload</Link></li>
        ...
        <div className="border-t border-border/50 mt-12 pt-8 flex flex-col md:flex-row justify-between items-center">
          <p className="text-sm text-muted-foreground">
            &copy; {currentYear} TalentGenius. All rights reserved.
          </p>
